...
C='\033[0m' #CLEAR
N = '\x1b[0m' # WARNA MATI
USN="Mozilla/5.0 (Linux; U; Android 11; zh-cn; Redmi K30 5G Build/RKQ1.200826.002) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/89.0.4389.116 Mobile Safari/537.36 XiaoMi/MiuiBrowser/16.6.6 swan-mibrowser"
# USN="Mozilla/5.0 (Linux; U; Android 10; ru-ru; Redmi 9C NFC Build/QP1A.190711.020) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/89.0.4389.116 Mobile Safari/537.36 XiaoMi/MiuiBrowser/13.6.0-gn"
...
[bold green] PENGEMBANGAN : OL3NG
 GITHUB       : PRIVAT
 WA           : 85803102583
 TEAM         : OL3NG
                             """, title=f"{waktu()}" , subtitle="[on cyan] Version 2.3"))
...
[{H}•{C}]Following      : {following}'''
    ...
    def crackAPI(self,user,pas):
        ...
        sys.stdout.write(f"\r{CY}┣[R] [{K}{loop}/{len(internal)}{C}] {H}[ OK : {len(success)}]{C}  {K}[ CP : {len(checkpoint)}]{C} "),sys.stdout.flush()
        try:
            for pw in pas:
